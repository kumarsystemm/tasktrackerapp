...
class _TasksClient implements TasksClient {
  ...
  Future<TaskListResponse> getTasks({
    ...
    final _options = _setStreamType<TaskListResponse>(
    ...
    late TaskListResponse _value;
    try {
      _value = TaskListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<TaskResponse> createTask({required CreateTaskRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<TaskResponse> getTaskById({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<DeleteResponse> deleteTask({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<TaskResponse> updateTaskStatus({
    required String id,
    required UpdateStatusRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
