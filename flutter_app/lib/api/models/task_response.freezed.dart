...
abstract class $TaskResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool success, String message, Task data});
...
class _$TaskResponseImpl implements _TaskResponse {
  ...
  @override
  String toString() {
    return 'TaskResponse(success: $success, message: $message, data: $data)';
  }
...
abstract class _TaskResponse implements TaskResponse {
  const factory _TaskResponse(
      ...
      required final Task data}) = _$TaskResponseImpl;
