...
/// @nodoc
mixin _$PaginatedTasksResponse {
  List<Task> get tasks => throw _privateConstructorUsedError;
  PaginationMeta get pagination => throw _privateConstructorUsedError;

  /// Create a copy of PaginatedTasksResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PaginatedTasksResponseCopyWith<PaginatedTasksResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PaginatedTasksResponseCopyWith<$Res> {
  factory $PaginatedTasksResponseCopyWith(PaginatedTasksResponse value,
          $Res Function(PaginatedTasksResponse) then) =
      _$PaginatedTasksResponseCopyWithImpl<$Res, PaginatedTasksResponse>;
  @useResult
...
/// @nodoc
class _$PaginatedTasksResponseCopyWithImpl<$Res,
        $Val extends PaginatedTasksResponse>
    implements $PaginatedTasksResponseCopyWith<$Res> {
  _$PaginatedTasksResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PaginatedTasksResponseImplCopyWith<$Res>
    implements $PaginatedTasksResponseCopyWith<$Res> {
  factory _$$PaginatedTasksResponseImplCopyWith(
          _$PaginatedTasksResponseImpl value,
          $Res Function(_$PaginatedTasksResponseImpl) then) =
      __$$PaginatedTasksResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({List<Task> tasks, PaginationMeta pagination});
...
/// @nodoc
class __$$PaginatedTasksResponseImplCopyWithImpl<$Res>
    extends _$PaginatedTasksResponseCopyWithImpl<$Res,
        _$PaginatedTasksResponseImpl>
    implements _$$PaginatedTasksResponseImplCopyWith<$Res> {
  __$$PaginatedTasksResponseImplCopyWithImpl(
      _$PaginatedTasksResponseImpl _value,
      $Res Function(_$PaginatedTasksResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PaginatedTasksResponseImpl(
      tasks: null == tasks
          ? _value._tasks
          : tasks // ignore: cast_nullable_to_non_nullable
              as List<Task>,
...
class _$PaginatedTasksResponseImpl implements _PaginatedTasksResponse {
  const _$PaginatedTasksResponseImpl(
  ...
  @override
  String toString() {
    return 'PaginatedTasksResponse(tasks: $tasks, pagination: $pagination)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PaginatedTasksResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PaginatedTasksResponseImplCopyWith<_$PaginatedTasksResponseImpl>
      get copyWith => __$$PaginatedTasksResponseImplCopyWithImpl<
          _$PaginatedTasksResponseImpl>(this, _$identity);
}

abstract class _PaginatedTasksResponse implements PaginatedTasksResponse {
  const factory _PaginatedTasksResponse(
      {required final List<Task> tasks,
      required final PaginationMeta pagination}) = _$PaginatedTasksResponseImpl;
